...
def main(DATASET, NETWORK):
    ...
    if DATASET == 7:
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/6.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/6.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.SVHN(args.batch_size)), 10
    ...
    if DATASET == 0:
        ...
        if NETWORK == 1:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            ...
            if not args.pretrained:
                capAlex = AlexNet_Module.AlexCapsNet_BreastMNIST(device).to(device)
                print(
        ...
        if NETWORK == 2:
            ...
            args = _arparse(epoch=300, lr=0.001, r=3, lr_decay=0.995, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=100,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            ...
            if not args.pretrained:
                # get AlexNet
                Alex = AlexNet_Module.AlexNet_BreastMNIST(device).to(device)
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            ...
            if not args.pretrained:
                capnet = AlexNet_Module.CapsNet_BreastMNIST(device).to(device)
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.BreastMNIST(args.batch_size)), 2
            ...
            if not args.pretrained:
                capnet_recon = AlexNet_Module.CapsNet_Recon_BreastMNIST(device).to(device)
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/6.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/6.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.BreastMNIST(args.batch_size)), 2
            ...
            if not args.pretrained:
                alexcapnet_recon = AlexNet_Module.AlexCapsNet_Recon_BreastMNIST(device).to(device)
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            ...
            if not args.pretrained:
                capAlex = AlexNet_Module.S_AlexCapsNet_BreastMNIST(device).to(device)
