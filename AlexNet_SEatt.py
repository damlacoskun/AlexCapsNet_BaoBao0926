...
def _arparse(epoch, batch_size, lr, lr_decay, r, num_save_epoch, train_save_dir, train_eval,
    ...
    parser.add_argument('--seed', default=0, type=int, help="Random seed (0–100)")
...
def main(DATASET, NETWORK):
    ...
    if DATASET == 1:
        ...
        if NETWORK == 1:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/1.AlexCapsNet/train',
                            train_eval=True,  # train while testing
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,  # whether to use the pretrained weight
                            pretrained_weight='./Result/CIFAR10/AlexCapsNet/train/best_train/model_299.pth',
        ...
        if NETWORK == 2:
            ...
            args = _arparse(epoch=300, lr=0.001, r=3, lr_decay=0.995, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR10/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR10(args.batch_size)), 10
            ...
            if not args.pretrained:
                ...
                Alex = AlexNet_Module.AlexNet_CIFAR10().to(device)
                Alex.load_state_dict(torch.load(args.pretrained_weight))
                print(f'The AlexNet for CIFAR10 architecture is shown:\n {Alex}')  # show architecture
                utils.train(Alex, train_loader, test_loader, args)
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR10/4.CapsNet_recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR10(args.batch_size)), 10
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR10/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR10(args.batch_size)), 10
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR10/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR10/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 2:
        ...
        if NETWORK == 1:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 2:
            ...
            args = _arparse(epoch=300, lr=0.001, r=3, lr_decay=0.995, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR100(args.batch_size)), 100
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR100(args.batch_size)), 100
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.CIFAR100(args.batch_size)), 100
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=100, recon_alpha=0.0005,
                            train_save_dir='./Result/CIFAR100/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/CIFAR100/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 3:
        ...
        if NETWORK == 1:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/MNIST/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 2:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,  # 是否要使用使用预训练
                            pretrained_weight='./Result/MNIST/2.AlexNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/MNIST/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/MNIST/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/MNIST/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/MNIST/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/MNIST/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 4:
        ...
        if NETWORK == 1:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 2:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/2.AlexNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/Fashion/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/Fashion/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 5:
        ...
        if NETWORK == 1:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=101, recon_alpha=0.0005,
                            train_save_dir='./Result/FOOD101/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            # FODD101
        ...
        if NETWORK == 2:
            ...
            args = _arparse(epoch=300, lr=0.0005, r=3, lr_decay=0.995, num_class=101, recon_alpha=0.0005,
                            train_save_dir='./Result/FOOD101/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=101, recon_alpha=0.0005,
                            train_save_dir='./Result/FOOD101/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.FOOD101(args.batch_size)), 101
        ...
        if NETWORK == 4:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=101, recon_alpha=0.00005,
                            train_save_dir='./Result/FOOD101/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.FOOD101(args.batch_size)), 101
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=101, recon_alpha=0.00005,
                            train_save_dir='./Result/FOOD101/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.FOOD101(args.batch_size)), 101
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=101, recon_alpha=0.0005,
                            train_save_dir='./Result/FOOD101/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FOOD101/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 6:
        ...
        if NETWORK == 1:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=102, recon_alpha=0.0005,
                            train_save_dir='./Result/FLOWER102/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
        ...
        if NETWORK == 2:
            ...
            args = _arparse(epoch=300, lr=0.0005, r=3, lr_decay=0.995, num_class=102, recon_alpha=0.0005,
                            train_save_dir='./Result/FLOWER102/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=102, recon_alpha=0.0005,
                            train_save_dir='./Result/FLOWER102/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.FLOWER102(args.batch_size)), 102
        ...
        if NETWORK == 4:
            ...
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=102, recon_alpha=0.00005,
                            train_save_dir='./Result/FLOWER102/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.FLOWER102(args.batch_size)), 102
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=102, recon_alpha=0.0005,
                            train_save_dir='./Result/FLOWER102/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=102, recon_alpha=0.0005,
                            train_save_dir='./Result/FLOWER102/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/FLOWER102/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 7:
        ...
        if NETWORK == 1:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
        ...
        if NETWORK == 2:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, r=3, lr_decay=0.995, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=50,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.SVHN(args.batch_size)), 10
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.SVHN(args.batch_size)), 10
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=10, recon_alpha=0.0005,
                            train_save_dir='./Result/SVHN/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/SVHN/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
    ...
    if DATASET == 0:
        ...
        if NETWORK == 1:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/1.AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/1.AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            train_loader, test_loader = dataloaders.BreastMNIST(args.batch_size)

            if not args.pretrained:
                capAlex = AlexNet_Module_SE.AlexCapsNet_BreastMNIST_SE(device).to(device)
                print(
                    f'The AlexCapsNet for BreastMNIST architecture is shown:\n {capAlex}')  # show architecture
                utils.train_capOutput(capAlex, train_loader, test_loader, args)
            else:
                capAlex = AlexNet_Module_SE.AlexCapsNet_BreastMNIST_SE(device).to(device)
                capAlex.load_state_dict(torch.load(args.pretrained_weight))
        ...
        if NETWORK == 2:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, r=3, lr_decay=0.995, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/2.AlexNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=100,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/2.AlexNet/train/train1/model_2.pth',
                            reconstruction=False
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.BreastMNIST(args.batch_size)), 2

            if not args.pretrained:
                # get AlexNet
                Alex = AlexNet_Module_SE.AlexNet_BreastMNIST_SE(device).to(device)
        ...
        if NETWORK == 3:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/3.CapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/3.CapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            ...
            if not args.pretrained:
                capnet = AlexNet_Module_SE.CapsNet_BreastMNIST_SE(device).to(device)
                print(f'The CapsNet for BreastMNIST architecture is shown:\n {capnet}')  # show architecture
                utils.train_capOutput(capnet, train_loader, test_loader, args)
            else:
                capnet = AlexNet_Module_SE.CapsNet_BreastMNIST_SE(device).to(device)
                capnet.load_state_dict(torch.load(args.pretrained_weight))
        ...
        if NETWORK == 4:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/4.CapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/4.CapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.BreastMNIST(args.batch_size)), 2
            ...
            if not args.pretrained:
                capnet_recon = AlexNet_Module_SE.CapsNet_Recon_BreastMNIST_SE(device).to(device)
                print(f'The CapsNet-Recon for BreastMNIST architecture is shown:\n {capnet_recon}')  # show architecture
                utils.train_capOutput(capnet_recon, train_loader, test_loader, args)
            else:
                capnet_recon = AlexNet_Module_SE.CapsNet_Recon_BreastMNIST_SE(device).to(device)
                capnet_recon.load_state_dict(torch.load(args.pretrained_weight))
        ...
        if NETWORK == 5:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/5.AlexCapsNet_Recon/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=300,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/5.AlexCapsNet_Recon/train/best_train/model_299.pth',
                            reconstruction=True
                            )
            # get corresponding dataset
            (train_loader, test_loader), num_class = (dataloaders.BreastMNIST(args.batch_size)), 2
            ...
            if not args.pretrained:
                alexcapnet_recon = AlexNet_Module_SE.AlexCapsNet_Recon_BreastMNIST_SE(device).to(device)
                print(f'The AlexCapsNet-Recon for BreastMNIST architecture is shown:\n {alexcapnet_recon}')  # show architecture
                utils.train_capOutput(alexcapnet_recon, train_loader, test_loader, args)
            else:
                alexcapnet_recon = AlexNet_Module_SE.AlexCapsNet_Recon_BreastMNIST_SE(device).to(device)
                alexcapnet_recon.load_state_dict(torch.load(args.pretrained_weight))
        ...
        if NETWORK == 6:
            # get parameter
            args = _arparse(epoch=300, lr=0.001, lr_decay=0.995, r=3, num_class=2, recon_alpha=0.0005,
                            train_save_dir='./Result/BreastMNIST_SE/6.S_AlexCapsNet/train',
                            train_eval=True,
                            save_all=False,
                            batch_size=50,
                            num_save_epoch=1,
                            pretrained=False,
                            pretrained_weight='./Result/BreastMNIST_SE/6.S_AlexCapsNet/train/best_train/model_299.pth',
                            reconstruction=False
                            )
            ...
            if not args.pretrained:
                capAlex = AlexNet_Module_SE.S_AlexCapsNet_BreastMNIST_SE(device).to(device)
                print(f'The CapsAlexNet for BreastMNIST architecture is shown:\n {capAlex}')  # show architecture
                utils.train_capOutput(capAlex, train_loader, test_loader, args)
            else:
                capAlex = AlexNet_Module_SE.S_AlexCapsNet_BreastMNIST_SE(device).to(device)
                capAlex.load_state_dict(torch.load(args.pretrained_weight))
...
if __name__ == '__main__':
    ...
    # FOOD101: 5    FLOWER102: 6    SVHN:   7    BreastMNIST: 0
    DATASET = 0
