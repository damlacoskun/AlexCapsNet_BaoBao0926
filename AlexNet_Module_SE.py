...
class AlexCapsNet_BreastMNIST_SE(nn.Module):

    def __init__(self, device):
        super(AlexCapsNet_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50, 28, 28]
            nn.Conv2d(in_channels=1, out_channels=96, kernel_size=3, stride=1, padding=1),  # [50, 96,28,28]
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1),  # [50, 96,14,14]
...
# 2: AlexNet
class AlexNet_BreastMNIST_SE(nn.Module):
    def __init__(self, device):
        super(AlexNet_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50, 28, 28]
            nn.Conv2d(in_channels=1, out_channels=96, kernel_size=3, stride=1, padding=1),  # [50, 96,28,28]
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1),  # [50, 96,14,14]
...
# 3: CapsNet 32*32
class CapsNet_BreastMNIST_SE(nn.Module):

    def __init__(self, device):
        super(CapsNet_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50,  3,28,28]
            nn.Conv2d(in_channels=1, out_channels=256, kernel_size=9, stride=1, padding=0),  # [batch_size, 256, 20, 20]
            nn.ReLU()
        )
...
# 4 CapNet-Recon
class CapsNet_Recon_BreastMNIST_SE(nn.Module):
    def __init__(self, device):
        super(CapsNet_Recon_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50, 3,28,28]
            nn.Conv2d(in_channels=1, out_channels=256, kernel_size=9, stride=1, padding=0),  # [batch_size, 256, 20, 20]
            nn.ReLU()
        )
...
# 5: AlexCapsNet
class AlexCapsNet_Recon_BreastMNIST_SE(nn.Module):
    def __init__(self, device):
        super(AlexCapsNet_Recon_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50, 28, 28]
            nn.Conv2d(in_channels=1, out_channels=96, kernel_size=3, stride=1, padding=1),  # [50, 96,28,28]
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1),  # [50, 96,14,14]
...
# 6: Shallow AlexCapsNet
class S_AlexCapsNet_BreastMNIST_SE(nn.Module):

    def __init__(self, device):
        super(S_AlexCapsNet_BreastMNIST_SE, self).__init__()
        self.conv = nn.Sequential(  # [50, 28, 28]
            nn.Conv2d(in_channels=1, out_channels=96, kernel_size=3, stride=1, padding=1),  # [50, 96,28,28]
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1),  # [50, 96,14,14]
        ...
        self.se = SELayer(channel=384, reduction=16)
        self.Cap = nn.Sequential(
            utils.PrimaryCaps(num_caps=32, in_channel=384, out_channel=8, kersel_size=2, stride=1, padding=0),
            # 32*[50,8,4,4]->[50,8,16,32]->[50,8,16*32(512)]
            utils.DenseCapsule(in_num_caps=512, in_dim_caps=8, out_num_caps=2, out_dim_caps=16,
